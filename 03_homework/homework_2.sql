...
SELECT product_id, product_name,
       CASE WHEN product_qty_type is 'unit' THEN 'unit' ELSE 'bulk' END AS prod_qty_type_condensed
...
SELECT *
FROM vendor v
INNER JOIN vendor_booth_assignments vb ON vb.vendor_id = v.vendor_id
